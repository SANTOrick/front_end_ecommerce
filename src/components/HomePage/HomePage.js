    ...
    this.state = {
      todayItems: [
        ...
        },
        {
          ...
          price: "1.300.00",
          image:
            "https://i.dailymail.co.uk/i/pix/2015/08/09/16/2B377C0C00000578-0-image-a-123_1439132638416.jpg"
        }
      ],
      selectedItem: null
    };
    ...
    return (
      <Container>
        ...
        {this.state.selectedItem === null ? (
          <NewAddedItems
            images={this.state.todayItems}
            handleClick={this._detailedInfo}
          />
        ) : (
          <SingleItemView
