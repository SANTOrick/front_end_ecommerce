...
export default class SingleItemView extends React.Component{
  ...
  render(){
    return(
      <div>
      <Card>
        <CardImg top width="100%" className="detailedImage" src={this.props.selectedItem.image} alt={this.props.selectedItem.name} />
        <CardBody>
          ...
          <Button onClick={()=>this.props.addToMyCart(this.props.selectedItem)}>Add to my cart</Button>
